package by.it.group973601.apenka.lesson03;
...
public class A_Huffman {
    ...
    abstract class Node implements Comparable<by.it.group973601.apenka.lesson03.A_Huffman.Node> {
        ...
        //или для сортировок
        @Override
        public int compareTo(by.it.group973601.apenka.lesson03.A_Huffman.Node o) {
    ...
    private class InternalNode extends by.it.group973601.apenka.lesson03.A_Huffman.Node {
        //внутренный узел дерева
        by.it.group973601.apenka.lesson03.A_Huffman.Node left;  //левый ребенок бинарного дерева
        by.it.group973601.apenka.lesson03.A_Huffman.Node right; //правый ребенок бинарного дерева

        //для этого дерева не существует внутренних узлов без обоих детей
        //поэтому вот такого конструктора будет достаточно
        InternalNode(by.it.group973601.apenka.lesson03.A_Huffman.Node left,by.it.group973601.apenka.lesson03.A_Huffman.Node right) {
    ...
    private class LeafNode extends by.it.group973601.apenka.lesson03.A_Huffman.Node {
        //лист
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        PriorityQueue<by.it.group973601.apenka.lesson03.A_Huffman.Node> priorityQueue = new PriorityQueue<>();
        for (Map.Entry temp : count.entrySet()) {
            priorityQueue.add(new by.it.group973601.apenka.lesson03.A_Huffman.LeafNode( (int)temp.getValue(), (char)temp.getKey()));
        }
        ...
        while(priorityQueue.size()>1){
            by.it.group973601.apenka.lesson03.A_Huffman.Node leftNode=priorityQueue.peek();
            priorityQueue.remove();
            by.it.group973601.apenka.lesson03.A_Huffman.Node rightNode=priorityQueue.peek();
            priorityQueue.remove();
            priorityQueue.add(new by.it.group973601.apenka.lesson03.A_Huffman.InternalNode(leftNode,rightNode));
        }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f = new File(root + "by/it/group973601/apenka/lesson03/dataHuffman.txt");
        by.it.group973601.apenka.lesson03.A_Huffman instance = new by.it.group973601.apenka.lesson03.A_Huffman();
